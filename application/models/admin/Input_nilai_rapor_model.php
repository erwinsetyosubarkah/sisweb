...
class Input_nilai_rapor_model extends CI_Model{
    ...
    public function buatQuery($tabel,$select_column = [],$order_column = [],$where)
    {
        ...
        $this->db->where('nilai.id_agenda_mengajar',$where['id_agenda_mengajar']);
       
        $this->db->join('nilai', 'nilai.id_siswa = siswa.id_siswa', 'left');
        $this->db->join('kelas', 'siswa.id_kelas = kelas.id_kelas', 'left');
        $this->db->join('agenda_mengajar', 'agenda_mengajar.id_agenda_mengajar = nilai.id_agenda_mengajar', 'left');
    ...
    public function inputNilaiRapor($data = [],$tabel)
    {
        ...
        foreach($data as $dt){
            ...
            $absen = [
                "pengetahuan_nilai" => $dt['pengetahuan_nilai'],
                "keterampilan_nilai" => $dt['keterampilan_nilai']
