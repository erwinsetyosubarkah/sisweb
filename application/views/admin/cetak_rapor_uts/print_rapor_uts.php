...
<div class="container-fluid pt-2">
            ...
            <hr class="mb-4">
            <h4 class="text-center mb-3">RAPOR UTS <?= strtoupper($semester['semester']); ?> TAHUN PELAJARAN <?= strtoupper($tahun_pelajaran['tahun_pelajaran']); ?></h4>
            <table>
                <tr>
                    <td>Nama Sekolah</td>
