            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">                  
                  <h4 class="m-0 font-weight-bold text-white mb-4">Presensi Siswa</h4>                  
                </div>
        ...
        <script type="text/javascript" src="<?=base_url('assets/js/absensi_siswa/absensi_siswa.js')?>"></script>
