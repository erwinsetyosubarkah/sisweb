              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body overflow-scroll"> 
                  ...
                  <table class="table">                     
                    ...
                    <button type="submit" id="btn-input-nilai-uts" class="btn btn-primary mt-3">Simpan</button>
                    <a href="akademik-input-nilai-uts" class="btn btn-secondary float-right mt-3">Kembali</a>
                </div>
              </div>
        ...
        <script type="text/javascript" src="<?=base_url('assets/js/input_nilai_uts/masukan_nilai_uts.js')?>"></script>
