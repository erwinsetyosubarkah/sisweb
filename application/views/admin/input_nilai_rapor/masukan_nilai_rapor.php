            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">                  
                  <h4 class="m-0 font-weight-bold text-white mb-4">Input Nilai Rapor</h4>                  
                </div>
                <div class="card-body overflow-scroll"> 
                  ...
                  <table class="table">                     
                    ...
                    <button type="submit" id="btn-input-nilai-rapor" class="btn btn-primary mt-3">Simpan</button>
                    <a href="akademik-input-nilai-rapor" class="btn btn-secondary float-right mt-3">Kembali</a>
                </div>
              </div>
        ...
        <script type="text/javascript" src="<?=base_url('assets/js/input_nilai_rapor/masukan_nilai_rapor.js')?>"></script>
