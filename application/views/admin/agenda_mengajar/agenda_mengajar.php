            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">                  
                  <h4 class="m-0 font-weight-bold text-white mb-4">Agenda Mengajar</h4>                  
                </div>
                <div class="card-body overflow-scroll"> 
                  ...
                  <a href="" class="btn btn-success mb-3" data-toggle="modal" data-target="#modalAgendaMengajar"  id="btn-tambahModal"><i class="fas fa-fw fa-plus"></i> Tambah Agenda Mengajar</a>
        ...
        <!-- modal  -->
        <?php include "modal_agenda_mengajar.php"; ?>

        <script type="text/javascript" src="<?=base_url('assets/js/agenda_mengajar/agenda_mengajar.js')?>"></script>
