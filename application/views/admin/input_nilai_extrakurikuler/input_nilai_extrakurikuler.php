            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">                  
                  <h4 class="m-0 font-weight-bold text-white mb-4">Input Nilai Extrakurikuler</h4>                  
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <button type="submit" id="btn-input-nilai-extrakurikuler" class="btn btn-primary mt-3">Simpan</button>
                </div>
              </div>
        ...
        <script type="text/javascript" src="<?=base_url('assets/js/input_nilai_extrakurikuler/input_nilai_extrakurikuler.js')?>"></script>
